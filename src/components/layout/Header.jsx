      ...
      <div className="flex items-center gap-4 w-full max-w-xl">
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full bg-zinc-900/50 border border-transparent focus:bg-zinc-900 border-zinc-800 rounded-xl pl-10 pr-4 py-2 text-base sm:text-sm text-zinc-200 placeholder:text-zinc-600 focus:outline-none outline-none focus:ring-2 focus:ring-blue-500/10 transition-all"
          />
        </div>
      </div>
